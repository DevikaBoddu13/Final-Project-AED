...
public class ReceptionAmbulanceWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public void setUpTextFields(Patient p){
        txtPatientUserName.setText(p.getpatient_UserName());
        txtPatientFirstName.setText(p.getpatient_FirstName());
        txtPatientLastName.setText(p.getpatient_LastName());
        txtPatientLocation.setText(p.getpatient_LocationOfAccident());
    }
    /**
    ...
    private void initComponents() {
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 10, 480, 80));
        ...
        add(lblPatientFirstName, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 320, -1, -1));
        add(txtPatientFirstName, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 320, 250, 30));
        ...
        add(lblPatientLocation, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 440, 174, -1));
        ...
        add(lblPatientLastName, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 380, -1, -1));
        add(txtPatientLastName, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 380, 250, 30));

        lblPatientUserName.setBackground(new java.awt.Color(255, 255, 255));
        lblPatientUserName.setFont(new java.awt.Font("Arial Black", 1, 18)); // NOI18N
        lblPatientUserName.setForeground(new java.awt.Color(255, 255, 255));
        lblPatientUserName.setText("Patient User Name");
        add(lblPatientUserName, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 500, -1, 20));

        lblPatientPassword.setBackground(new java.awt.Color(255, 255, 255));
        lblPatientPassword.setFont(new java.awt.Font("Arial Black", 1, 18)); // NOI18N
        lblPatientPassword.setForeground(new java.awt.Color(255, 255, 255));
        lblPatientPassword.setText("Patient Password");
        add(lblPatientPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 560, -1, -1));
        add(txtPatientPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 560, 250, 30));
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        if (ecoSystem.getUserAccountDirectory().checkIfUsernameIsUnique(txtPatientUserName.getText())) {
            ...
            patient.setpatient_FirstName(txtPatientFirstName.getText());
            patient.setpatient_LastName(txtPatientLastName.getText());
            patient.setpatient_LocationOfAccident(txtPatientLocation.getText());
            patient.setpatient_Status("NewPatient");
            patient.setpatient_BloodBankStatus("NewPatient");
            patient.setpatient_PharmaStatus("NewPatient");
            ...
            for (Patient p : ecoSystem.getPatientDirectory().getPatientList()) {
                if (p.getpatient_UserName().equals(txtPatientUserName.getText())) {
