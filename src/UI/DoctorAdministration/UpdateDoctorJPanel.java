...
public class UpdateDoctorJPanel extends javax.swing.JPanel {
    ...
    public UpdateDoctorJPanel(JPanel userProcessContainer,User user, Ecosystem system, Doctor d) {
        ...
        this.d=d;
        txtAddress.setText(d.getDoc_Address());
        txtAge.setText(Integer.toHexString(d.getDoc_Age()));
        //txtDateOfBirth.setText(d.getDateofBirth());
        txtDoctorID.setText(d.getDoc_ID());
        txtEmail.setText(d.getDoc_Mail());
        txtExperience.setText(d.getDoc_Experience());
        txtFirstName.setText(d.getDoctor_FirstName());
        txtLastName.setText(d.getDoctor_LastName());
        txtGender.setText(d.getDoc_Gender());
        txtPhoneNumber.setText(d.getDoc_PhoneNumber());
        txtSpecialist.setText(d.getDoc_Specialization());
        txtUsername.setText(d.getDoctor_UserName());
    }
    ...
    private void initComponents() {
        ...
        lblRestaurantName.setFont(new java.awt.Font("Arial Black", 1, 14)); // NOI18N
        lblRestaurantName.setForeground(new java.awt.Color(255, 255, 255));
        lblRestaurantName.setText("First Name");
        jPanel1.add(lblRestaurantName, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 220, 113, -1));
        ...
        jPanel1.add(lblRestaurantInfo, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 40, 500, -1));
        jPanel1.add(txtFirstName, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 210, 170, 33));
        ...
        jPanel1.add(lblAddress, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 250, 40, -1));
        ...
        jPanel1.add(txtAge, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 250, 170, 30));
        ...
        jPanel1.add(lblAddress1, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 330, 120, 30));
        ...
        jPanel1.add(txtPhoneNumber, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 330, 170, 30));
        ...
        jPanel1.add(lblPhoneNumber2, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 290, -1, -1));
        ...
        jPanel1.add(txtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 290, 170, 30));
        ...
        jPanel1.add(lblAddress4, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 370, -1, 30));
        ...
        jPanel1.add(txtExperience, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 370, 170, 30));
        ...
        jPanel1.add(txtUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 170, 170, 33));
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        // TODO add your handling code here:
       d.setDoctor_FirstName(txtFirstName.getText());
        d.setDoctor_LastName(txtLastName.getText());
       d.setDoc_Age(Integer.parseInt( txtAge.getText()));
        d.setDoc_Gender(txtGender.getText());
        d.setDoc_ID(txtDoctorID.getText());
        d.setDoc_Address(txtAddress.getText());
        d.setDoc_PhoneNumber(txtPhoneNumber.getText());
        d.setDoc_Mail(txtEmail.getText());
        d.setDoc_Specialization(txtSpecialist.getText());
        d.setDoc_Experience(txtExperience.getText());
