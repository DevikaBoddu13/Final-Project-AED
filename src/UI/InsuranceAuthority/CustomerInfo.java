...
public class CustomerInfo extends javax.swing.JPanel {
    ...
    public CustomerInfo(JPanel userProcessContainer, Ecosystem business, Patient p, User account) {
        ...
        txtpLastName.setText(p.getpatient_LastName());
        ...
        txtphInsuranceID.setText(p.getpatient_HealthInsuranceID());
        txtpNumber.setText(p.getpatient_MobNum());
        txtpVerification.setText(p.getpatient_PoliceStatus());
        try{
            String s = p.getpatient_HealthInsuranceID().substring(3,7)+"-"+p.getpatient_HealthInsuranceID().substring(7,9)+"-"+p.getpatient_HealthInsuranceID().substring(9,11);
    ...
    private void aprvBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aprvBtnActionPerformed
        // TODO add your handling code here:
        patient.setpatient_InsuranceStatus("Approved");
        try{
        //ecoSystem.sendEmail("hospital.aed@zohomail.com", "Approval Confirmation for "+patient.getpatient_FirstName(), "Patient Insurance Approved Name: "+patient.getpatient_FirstName()+" "+patient.getpatient_LastName(), "insurance.aed@zohomail.com", "Bangbang@8899");
        }
        catch(Exception e){}
    ...
    private void rjctBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rjctBtnActionPerformed
        // TODO add your handling code here:
        patient.setpatient_InsuranceStatus("Rejected");
        InsuranceWorkAreaJPanel bill = new InsuranceWorkAreaJPanel(userProcessContainer, user, ecoSystem);
        userProcessContainer.add("Insurance main", bill);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
    ...
    private void verificationBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_verificationBtnActionPerformed
        // TODO add your handling code here:
        if(patient.getpatient_PoliceStatus().equals("Verifying")||patient.getpatient_PoliceStatus().equals("Verified")||patient.getpatient_PoliceStatus().equals("Rejected")){
            JOptionPane.showMessageDialog(null, "Already verifying/Verified.");
        }
        else{
        patient.setpatient_PoliceStatus("Verifying");
        ecoSystem.getPoliceRecords().addtoRecord(patient);
        txtpVerification.setText(patient.getpatient_PoliceStatus());
        }
