    ...
    private void btnUpdateAmbulanceRecordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateAmbulanceRecordActionPerformed
        ...
        else 
        {
            ...
            if(patient.getpatient_InsuranceStatus().equals("Verifying Insurance")){
                ...
                SendMail.sendMail(patient.getpatient_EmailAddress(), "Hello "+patient.getpatient_FirstName()+", <br/>Cash Payment Processed. Total Bill Amount is :"+String.valueOf(totalAmount)+"<br/>Thank you, <br/>Infirmary Management System.");
                JOptionPane.showMessageDialog(null, "Cash payment Received.Patient Discharged.", "Information", JOptionPane.INFORMATION_MESSAGE);
            }
            else{
                patient.setpatient_Status("Discharged");
                SendMail.sendMail(patient.getpatient_EmailAddress(), "Hello "+patient.getpatient_FirstName()+", <br/>Insurance Payment Cleared. Total Bill Amount is :"+String.valueOf(totalAmount)+"<br/>Thank you, <br/>Infirmary Management System.");
