 ...
 * @author kshama
 */
public class DispensaryTestsRequested extends javax.swing.JPanel {
    ...
    User account;
    Ecosystem ecoSystem;
    public DispensaryTestsRequested(JPanel userProcessContainer, User account, Patient p,Ecosystem ecoSystem) {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        p.setpatient_PharmaStatus("Delivered");
        populateBillTable();
        DispensaryWorkSpaceJPanel bill = new DispensaryWorkSpaceJPanel(userProcessContainer, account, ecoSystem);
