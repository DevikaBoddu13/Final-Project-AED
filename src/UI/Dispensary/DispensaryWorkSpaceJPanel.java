 ...
 * @author kshama
 */
public class DispensaryWorkSpaceJPanel extends javax.swing.JPanel {
    ...
    public DispensaryWorkSpaceJPanel(JPanel userProcessContainer, User account, Ecosystem business) {
        initComponents();
    ...
    private void populatePatientTable() {
        ...
        for (Patient patient : ecosystem.getPharmacy().getPharmaRecordList()) {
            ...
            row[2] = patient.getpatient_PharmaStatus();
            row[3] = patient.getpatient_HealthInsuranceID();
            row[4] = patient.getpatient_Age();
            row[5] = patient.getpatient_Address();
            row[6] = patient.getpatient_EmailAddress();
            row[7] = patient;
           if(patient.getpatient_PharmaStatus().equals("Requested")){
            model.addRow(row);
           }
        }
    }
        ...
        for (Patient patient : ecosystem.getPharmacy().getPharmaRecordList()) {
            ...
            row[6] = patient.getpatient_EmailAddress();
            row[7] = patient;
           if(patient.getpatient_PharmaStatus().equals("Delivered")){
            model.addRow(row);
           }
        }
    }
    ...
    private void initComponents() {
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 20, 270, 50));
        ...
        jButton1.setText("Update Catalog");
        ...
        managePatientTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "FirstName", "LastName", "DispenseStatus", "HealthId", "Age", "Address", "Email", "obj"
            }
        ) {
        ...
        jButton3.setForeground(new java.awt.Color(202, 97, 73));
        jButton3.setText("View Appeal");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UI/Images/icons8-pharmacy-50.png"))); // NOI18N
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 10, 90, 70));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        else 
        {
            ...
            DispensaryTestsRequested doctorRequestLabTestJPanel = new DispensaryTestsRequested(userProcessContainer, userAccount,patient,ecosystem);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        DispensaryFunctionsJpanel doctorRequestLabTestJPanel = new DispensaryFunctionsJpanel(userProcessContainer, userAccount,ecosystem);
        userProcessContainer.add("Request Lab Tests", doctorRequestLabTestJPanel);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        else 
        {
            ...
            DispensaryFormerAppeal doctorRequestLabTestJPanel = new DispensaryFormerAppeal(userProcessContainer, userAccount,patient,ecosystem);
