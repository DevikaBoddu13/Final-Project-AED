...
public class DoctorRequestMedicineJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnRemoveMedicine.setFont(new java.awt.Font("Arial Black", 1, 12)); // NOI18N
        btnRemoveMedicine.setForeground(new java.awt.Color(40, 157, 144));
        btnRemoveMedicine.setText("ADD back to Dispensary");
        ...
        btnAddMedicine1.setText("ADD to Medicines for Patient");
    ...
    private void RequestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RequestActionPerformed
        ...
        if(items.size()==0){
            ...
            patient.setpatient_PharmaStatus("Requested");
