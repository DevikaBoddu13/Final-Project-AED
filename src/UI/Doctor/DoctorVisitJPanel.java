...
public class DoctorVisitJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 150, 1340, 191));
        ...
        btnRequestLabTests.setText("Diagnostic Tests");
        btnRequestLabTests.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnRequestLabTestsActionPerformed(evt);
            }
        });
        add(btnRequestLabTests, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 360, 280, 30));

        btnRequestMedicine.setFont(new java.awt.Font("Arial Black", 1, 18)); // NOI18N
        btnRequestMedicine.setForeground(new java.awt.Color(40, 157, 144));
        btnRequestMedicine.setText("Dispensary");
        btnRequestMedicine.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnRequestMedicineActionPerformed(evt);
            }
        });
        add(btnRequestMedicine, new org.netbeans.lib.awtextra.AbsoluteConstraints(1150, 360, 260, 30));

        btnRequestBlood.setFont(new java.awt.Font("Arial Black", 1, 18)); // NOI18N
        btnRequestBlood.setForeground(new java.awt.Color(40, 157, 144));
        btnRequestBlood.setText("Blood Bank");
        btnRequestBlood.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnRequestBloodActionPerformed(evt);
            }
        });
        add(btnRequestBlood, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 360, 270, 30));

        btnRequestMedicine1.setFont(new java.awt.Font("Arial Black", 1, 18)); // NOI18N
        btnRequestMedicine1.setForeground(new java.awt.Color(202, 97, 71));
        btnRequestMedicine1.setText("Patient Ready for Discharge");
        ...
        btnRequestMedicine2.setText("Conclude Visit");
    ...
    private void btnRequestMedicine1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRequestMedicine1ActionPerformed
        // TODO add your handling code here:
        patient.setpatient_Status("Ready to Discharge");
    ...
    private void btnRequestMedicine2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRequestMedicine2ActionPerformed
        // TODO add your handling code here:
        patient.setpatient_Status("Under Observation");
        DoctorWorkAreaJPanel doctor = new DoctorWorkAreaJPanel(userProcessContainer,userAccount,ecoSystem);
        userProcessContainer.add("Request Blood", doctor);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
