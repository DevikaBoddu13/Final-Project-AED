...
public class DoctorRequestLabTestJPanel extends javax.swing.JPanel {
    ...
    private void populatePatientTable() {
        ...
        for (Patient patient : ecosystem.getPatientDirectory().getPatientList()) {
            ...
            row[0] = patient.getpatient_UserName();
            row[1] = patient.getpatient_HealthInsuranceID();
            row[2] = patient.getpatient_FirstName();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Diagnostic Tests");
        ...
        btnAddTest.setFont(new java.awt.Font("Arial Black", 1, 12)); // NOI18N
        btnAddTest.setForeground(new java.awt.Color(40, 157, 144));
        btnAddTest.setText("ADD to Selected Tests");
        ...
        btnRemoveTest.setText("ADD back to Available Tests");
        ...
        Request1.setForeground(new java.awt.Color(40, 157, 144));
        ...
        add(Request1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 50, 40));
        ...
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 120, -1, -1));
    ...
    private void RequestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RequestActionPerformed
        ...
        patient.setpatient_Status("Requested");
        }
