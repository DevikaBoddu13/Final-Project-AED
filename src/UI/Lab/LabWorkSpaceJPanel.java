 ...
 * @author kshama
 */
public class LabWorkSpaceJPanel extends javax.swing.JPanel {
    ...
    public LabWorkSpaceJPanel(JPanel userProcessContainer, User account, Ecosystem business) {
        ...
        for (Patient patient : this.ecosystem.getLab().getLabRecordsList()) {
            ...
            row[5] = patient.getpatient_LabStatus();
            row[6] = patient;
            if(!patient.getpatient_LabStatus().equals("Delivered")){
            model.addRow(row);}
    ...
    private void initComponents() {
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 40, 280, 30));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        LabFunctions doctorRequestLabTestJPanel = new LabFunctions(userProcessContainer, userAccount,ecosystem);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        else 
        {
            ...
            LabTestsRequested doctorRequestLabTestJPanel = new LabTestsRequested(userProcessContainer, userAccount,patient,ecosystem);
            userProcessContainer.add("Request Lab Tests", doctorRequestLabTestJPanel);
            CardLayout layout = (CardLayout) userProcessContainer.getLayout();
            layout.next(userProcessContainer);
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        else 
        {
            ...
            LabFormerAppeal doctorRequestLabTestJPanel = new LabFormerAppeal(userProcessContainer, userAccount,patient,ecosystem);
